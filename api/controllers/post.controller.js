...
module.exports.postComment = asyncHandler(async (req, res) => {
  try {
    ...
    return res.status(201).json({ status: 201, data: newComment,statusText:'New Comment Added!' });
  } catch (error) {
    console.error(error);
    return res.status(500).json({ error: "Internal Server Error" });
  }
...
module.exports.postCommentReply = asyncHandler(async (req, res) => {
  try {
    ...
    return res.status(201).json({ status: 201, data: newComment,statusText:'New Comment Replay Added!' });
  } catch (error) {
    console.error(error);
    return res.status(500).json({ error: "Internal Server Error" });
  }
  ...
  try {
    ...
    return res
      ...
      .json({
        status: 200,
        message: "Success",
        data: commentsWithBookmarkStatus,
      });
  } catch (error) {
    console.error(error);
    res.status(500).json({ error: "Internal Server Error" });
